...
if os.path.isfile("label_list"):
	...
	while True:
		...
		print ("Slant: "+comment)
		print("---------------------------------------------------")
		print("Your character assessments as per our system:")
		if(clf1.predict([[baseline_angle, slant_angle]]) == 0):
			print("You are less stable Emotionally,")
		else:
			print("You are more stable Emotionally,")
		if(clf2.predict([[letter_size, pen_pressure]]) == 0):
			print("also your Mental Energy/Will Power is Low,")
		else:
			print("also your Mental Energy/Will Power is High,")
		if(clf3.predict([[letter_size, top_margin]]) == 0):
			print("Sometimes you like to boast about yourself,")
		else:
			print("generally you are a humble person,")
		if(clf4.predict([[line_spacing, word_spacing]]) == 0):
			print("You are short tempered person and take time to adapt changes,")
		else:
			print("You are a peace loving person and adapt changes quickly,")
		if(clf5.predict([[slant_angle, top_margin]]) == 0):
			print("Discipline is not a strong point for you,")
		else:
			print("Discipline is a strong point for you,")
		if(clf6.predict([[letter_size, line_spacing]]) == 0):
			print("also you have Poor Concentration,")
		else:
			print("and you are able Concentrate ,")
		if(clf7.predict([[letter_size, word_spacing]]) == 0):
			print("Communication of information/thoughts to next person is clear,")
		else:
			print("Sometimes you are unable to communicate information/thoughts to next person,")
		if(clf8.predict([[line_spacing, word_spacing]]) == 0):
			print("You feel comfortable around more people.")
		else:
			print ("You feel less comfortable around more people.")
		print( "---------------------------------------------------")
